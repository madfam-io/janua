...
Welcome to the Janua API documentation. This guide covers all endpoints available in our secure identity platform API.
...
```bash
curl -X GET https://api.janua.dev/api/v1/users/profile \
...
```bash
npm install @janua/js-sdk
```

```javascript
import { JanuaClient } from '@janua/js-sdk'
...
- **GitHub Issues**: [https://github.com/madfam-io/janua/api/issues](https://github.com/madfam-io/janua/api/issues)
- **Email**: [api-support@janua.dev](mailto:api-support@janua.dev)
