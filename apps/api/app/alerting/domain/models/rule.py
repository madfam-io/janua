...
class AlertRule:
    ...
    def update_condition(self, metric_name: str, threshold_value: float, 
                        comparison_operator: str, evaluation_window_seconds: int = 300) -> None:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "channels": [
                {"channel_type": ch.channel_type, "enabled": ch.enabled} 
...
class RuleBuilder:
    ...
    def with_condition(self, metric_name: str, threshold_value: float, 
                      comparison_operator: str, evaluation_window_seconds: int = 300) -> "RuleBuilder":
        """Set rule condition"""
        operator_enum = ComparisonOperator(comparison_operator)
