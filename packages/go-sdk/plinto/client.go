// Package plinto provides a Go SDK for the Plinto authentication platform
package plinto
...
const (
	DefaultBaseURL = "https://plinto.dev"
	DefaultTimeout = 30 * time.Second
	Version        = "1.0.0"
)

// Client is the main Plinto SDK client
type Client struct {
	baseURL    string
...
// Config holds the configuration for the Plinto client
type Config struct {
	BaseURL  string
	APIKey   string
	TenantID string
...
// NewClient creates a new Plinto client
...
func (c *Client) request(ctx context.Context, method, path string, body interface{}) (*http.Response, error) {
	...
	req.Header.Set("User-Agent", fmt.Sprintf("plinto-go/%s", Version))
...
// APIError represents an error from the Plinto API
